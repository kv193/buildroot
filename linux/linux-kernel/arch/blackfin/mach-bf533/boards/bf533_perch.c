 ...
 */
const char bfin_board_name[] = "Kvarta BF533-PERCH";
...
static struct spi_board_info bfin_spi_board_info[] __initdata = {
...
#if defined(CONFIG_MMC_SPI) || defined(CONFIG_MMC_SPI_MODULE)
	{
		...
		.bus_num = 0,
		.chip_select = GPIO_PF2 + MAX_CTRL_CS,
	...
	.irq = IRQ_PF0,
	.bus_num = 0,
	.chip_select = GPIO_PF1 + MAX_CTRL_CS,	/* GPIO controlled SSEL */
	//.chip_select = 1,	/* GPIO controlled SSEL */
