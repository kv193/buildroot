...
define LIBBFGDOTS_INSTALL_STAGING_CMDS
	$(MAKE) -C $(@D) DESTDIR=$(STAGING_DIR) CONFIG_FMT_USE_FDPIC_ELF=$(BR2_BFIN_FDPIC) install
endef

define LIBBFGDOTS_INSTALL_TARGET_CMDS
	$(MAKE) -C $(@D) DESTDIR=$(TARGET_DIR) CONFIG_FMT_USE_FDPIC_ELF=$(BR2_BFIN_FDPIC) install
endef
